...
public class ConsultaService {
	...
	public Consulta criarConsulta(ConsultaDTO consultaDTO) throws ErroInternoException {
		...
		if (consultaDTO.getDataConsulta().getDayOfWeek().equals(DayOfWeek.SATURDAY)
				|| consultaDTO.getDataConsulta().getDayOfWeek().equals(DayOfWeek.SUNDAY)) {
			throw new ErroInternoException("AGENDAMENTOS APENAS DE SEGUNDA À SEXTA");
		}

		List<Consulta> consultas = consultaRepository.findConsultaByDataConsultaAndMedico(consultaDTO.getDataConsulta(),
				medico);
